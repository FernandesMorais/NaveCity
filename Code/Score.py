...
from Code.Const import C_GREEN, SCORE_POS, MENU_OPTION, COLOR_WHITE, C_BLACK
...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int], color):
        ...
        while True:
            ...
            if game_mode == MENU_OPTION[2]:
                if player_score[0] >= player_score[1]:
                    ...
                    text = 'Enter Player 2 (4 characters):'
